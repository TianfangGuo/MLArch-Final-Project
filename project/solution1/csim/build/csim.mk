...
HLS_SOURCES = ../../../../hls_src/tb.cpp ../../../../hls_src/accelerator.cpp
...
$(ObjDir)/tb.o: ../../../../hls_src/tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../hls_src/tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb.d

$(ObjDir)/accelerator.o: ../../../../hls_src/accelerator.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../hls_src/accelerator.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
